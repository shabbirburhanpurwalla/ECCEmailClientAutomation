       ...
       ************************************************************* 
       ...
       public boolean verifyStringContainsText(String inputString, String expectedString, String objName)
       {
             if(inputString.contains(expectedString)){
                               report.updateTestLog(objName, "'" + objName + "' :"+ "'" +expectedString +"'"+ " Verification is Success", Status.PASS);
                               return true;
                         } else{
                               report.updateTestLog(objName, objName + " : '"+ expectedString +"' Verification is Failure.", Status.FAIL);
                               return false;
                         }           
       }
        ...
        ************************************************************* 
        ...
        public boolean verifyStringContainsTextRemoveSpaces(String inputString, String expectedString, String objName)
        {
        	...
        	String exStringModified = RemoveCharacter(expectedString, ' ');
